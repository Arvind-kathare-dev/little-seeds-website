...
export default function ContactSection() {
  ...
  return (
    <section id="contact" style={{ padding: "90px 24px", background: `linear-gradient(170deg, ${C.tealLight} 0%, ${C.cream} 100%)` }}>
      <div style={{ maxWidth: 620, margin: "0 auto", textAlign: "center" }}>
        <FadeIn>
          <Image src="/logo.jpg" alt="" width={120} height={56} style={{ height: 56, width: "auto", margin: "0 auto 12px", display: "block" }} />
